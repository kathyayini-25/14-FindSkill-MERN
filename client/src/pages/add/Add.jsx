      ...
      <div className="container">
        ...
        <div className="sections">
          ...
          <div className="details">
            <label htmlFor="gigservicetitle">Service Title</label>
            <input
              type="text"
              name="shortTitle"
            ...
            <input type="number" name="deliveryTime" onChange={handleChange}  id="deliverytime"/>
            ...
            <form action="" className="add" onSubmit={handleFeature} >
              <input type="text" placeholder="e.g. page design" id="addfeatures"/>
            ...
            <input type="number" onChange={handleChange} name="price" id="gigprice" />
          </div>
        </div>
      </div>
    </div>
